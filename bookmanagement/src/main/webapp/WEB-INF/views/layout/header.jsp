				...
				<div class="row">
								...
								<div class="card-sp">
									<ul>
										<li>
											...
											<a href="/cart/view" style="color:#474c51;margin-top:7px;margin-left:5px;">Giỏ hàng</a>
											<ul>
												<li>
													<div class="row">
														<c:choose>
					...
					<div class="col-sm-6">
						<div class="header-menu">
							...
							<a class="/cart/view" href="/product/favo" style="color: #474c51;;margin-top:7px;margin-left:5px;">Sản phẩm đã thích</a>
						</div>
					</div>
				</div>
			</div>
