...
<nav class="navbar navbar-expand-sm navbar-dark"
	...
	<div class="container-fluid"
		style="height: 50px; padding: 0px 60px 0px 60px">
		<ul class="navbar-nav" style="margin-right: 450px">
			<li
				style="width: 280px; font-size: 20px; border-right: 1px solid gray;">
			...
			<!-- Dropdown -->
			<li class=" nav-avatar dropdown">
				<a class="dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
				 	<c:choose>
						<c:when test="${empty sessionScope.user }">
								<img src="/static/images/user/user.png"
								style="width: 50px; height: 50px;" /> 
						</c:when>
						<c:otherwise>
								<img src="/static/images/user/${form.photo}"
					...
					<c:choose>
						<c:when test="${empty sessionScope.user }">
							<ul class="dropdown-menu" style="margin: 7px 0 0 27px;">
						...
						<c:otherwise>
							<ul class="dropdown-menu" style="background-color: #FFF; margin: 7px 0 0 27px;" > 
								...
								<li style="border-bottom: 2px solid #EEEEEE;"><a href="/order/items">Danh sách sản phẩm đã mua</a></li>
