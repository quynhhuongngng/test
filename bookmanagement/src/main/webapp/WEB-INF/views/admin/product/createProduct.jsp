		...
		<form:form action="${base}/index" modelAttribute="entity"
			...
			<div class="row">
				<div class="form-group col-sm-6">
					...
					<div class="form-control">
						<form:radiobutton path="special" value="true" label=" Hiện" checked="checked"/>
				...
				<div class="form-group col-sm-6">
					...
					<div class="form-control">
						<form:radiobutton path="available" value="true" label=" Còn hàng" checked="checked"/>
			...
			<div class="form-group col-sm-6">
					...
					<form:input path="author" class="form-control"
						pattern=".{3,}" title="Tên tác giả phải từ 3 ký tự trở lên" />
				</div>
				<div class="form-group col-sm-6">
			...
			<div class="row">
				...
				<div class="form-group col-sm-12">
					<button class="btn btn-primary" formaction="create">Create</button></a>
				</div>
			</div>
		</form:form>
	</div>
