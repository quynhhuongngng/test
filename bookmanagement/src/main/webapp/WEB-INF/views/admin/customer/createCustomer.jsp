		...
		<form:form action="${base}/index" modelAttribute="entity" enctype="multipart/form-data">
			<div class="row">
				<div class="form-group col-sm-6">
					...
					<form:input path="username" class="form-control"
						readonly="${!empty entity.username}" required="required" pattern=".{4,}"
			...
			<div class="row">
				...
				<div class="form-group col-sm-6">
					...
					<div class="form-control">
						<form:radiobutton path="admin" value="true" label="Admin"  checked="checked"/>
			...
			<div class="row">
				...
				<div class="form-group col-sm-12">
					<button class="btn btn-primary" formaction="create" onClick="ValidateForm(this.form)">Create</button>
